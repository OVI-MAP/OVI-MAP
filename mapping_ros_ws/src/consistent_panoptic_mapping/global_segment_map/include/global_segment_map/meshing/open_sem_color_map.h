#ifndef GLOBAL_SEGMENT_MAP_MESHING_OPEN_SEM_COLOR_MAP_H_
#define GLOBAL_SEGMENT_MAP_MESHING_OPEN_SEM_COLOR_MAP_H_
...
class OpenSemanticColorMap {
public:

  void getColor(const OpenSemanticLabel& open_sem_label, Color* color);
  void setColor(const OpenSemanticLabel& open_sem_label, const Color* color);

  std::map<OpenSemanticLabel, Color> color_map_;
...
#endif  // GLOBAL_SEGMENT_MAP_MESHING_OPEN_SEM_COLOR_MAP_H_
