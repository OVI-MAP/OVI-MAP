...
typedef uint16_t OpenSemanticLabel;

// new feature vector of fixed size
constexpr int FeatureDim = 512; // should be known at compile-time
typedef std::array<float, FeatureDim> SemanticFeature;
