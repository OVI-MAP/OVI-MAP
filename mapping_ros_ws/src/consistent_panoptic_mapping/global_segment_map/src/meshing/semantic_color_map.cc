...
void SemanticColorMap::getColor(
...
Nyu13ColorMap::Nyu13ColorMap() : SemanticColorMap({
  {200, 200, 200},    // BG
  {20, 20, 20},       // Unknown
  {0, 128, 128},      // Bed
  {250, 50, 50},      // Books
...
Nyu40ColorMap::Nyu40ColorMap() : SemanticColorMap({ 
...
CocoColorMap::CocoColorMap() : SemanticColorMap({
...
CocoPanoColorMap::CocoPanoColorMap() : SemanticColorMap({ 
  {200,200,200}, 
